...
<div class="max-w-5xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-xl font-black text-slate-900 uppercase italic tracking-tighter">Profil Detail Mekanik</h1>
    </div>
            ...
            <div class="flex flex-col md:flex-row items-end gap-6 -mt-16 mb-10 relative z-10">
                <div class="relative">
                    <div class="w-40 h-48 bg-slate-200 rounded-[35px] border-[6px] border-white shadow-2xl overflow-hidden shadow-orange-900/10">
                        <img src="{{ $p->foto ?? 'https://via.placeholder.com/400x500' }}" class="w-full h-full object-cover" alt="Foto Pegawai">
                    </div>
    ...
    <span class="text-sm font-bold text-slate-800 italic uppercase">
        {{ ($p->tempat_lahir ?? 'Kosong') . ', ' . ($p->tanggal_lahir ?? '-') }}
    </span>
</div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col gap-1 border-l-4 border-slate-100 pl-4">
                        <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Nomor WhatsApp</span>
