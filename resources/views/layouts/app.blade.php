...
<body class="flex min-h-screen overflow-x-hidden">
    ...
    <div>
        ...
        <ul class="space-y-2">
            {{-- DATA MEKANIK: Hanya HRD & Manager --}}
            @if(in_array(Auth::user()->role, ['hrd', 'manager']))
            <li>
                <a href="{{ route('karyawan.index') }}" class="{{ request()->routeIs('karyawan.*') ? 'sidebar-item-active' : '' }} flex items-center gap-4 p-4 hover:bg-white/5 rounded-2xl text-sm font-bold transition group">
                    <i class="fas fa-user-gear w-5 group-hover:text-orange-400"></i> Data Mekanik
                </a>
            </li>
            @endif
            ...
            <li>
                <a href="{{ route('absensi.index') }}" class="{{ request()->routeIs('absensi.*') ? 'sidebar-item-active' : '' }} flex items-center gap-4 p-4 hover:bg-white/5 rounded-2xl text-sm font-bold transition group">
                    <i class="fas fa-stopwatch w-5 group-hover:text-orange-400"></i> Presensi Kru
                </a>
            </li>
            @endif
            ...
            {{-- KELOLA GAJI: Hanya Akuntan & Manager (HRD & Mekanik Hidden) --}}
    ...
    <div>
        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('users.index') }}" class="{{ request()->routeIs('users.*') ? 'sidebar-item-active' : '' }} flex items-center gap-4 p-4 hover:bg-white/5 rounded-2xl text-sm font-bold transition group">
